  ...
  return (
    <div>
      ...
      <main className="mx-auto max-w-5xl px-4 py-14">
        <h1 className="text-4xl font-semibold">SnapFIT Elite: one plan, everything included.</h1>
        <p className="mt-3 max-w-2xl text-sm text-muted-foreground">
          We&apos;ve simplified billing to a single premium plan so you get full access without managing multiple
          subscriptions.
        </p>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-1">
          <PricingCard tier="elite" cycle={cycle} cta="Start Elite" />
        </div>
      </main>
    </div>
  );
